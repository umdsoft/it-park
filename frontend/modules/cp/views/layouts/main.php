    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li><a class="has-arrow ai-icon" href="<?= Yii::$app->urlManager->createUrl(['/cp'])?>">
                        <i class="flaticon-381-networking"></i>
                        <span class="nav-text">Dashboard</span>
                    </a>

                </li>
                <li><a class="has-arrow ai-icon" href="<?= Yii::$app->urlManager->createUrl(['/cp/user'])?>">
                        <i class="flaticon-381-user-9"></i>
                        <span class="nav-text">Foydalanuvchilar</span>
                    </a>
                </li>
                <li><a class="has-arrow ai-icon" href="<?= Yii::$app->urlManager->createUrl(['/cp/rtom'])?>">
                        <i class="flaticon-381-home-1"></i>
                        <span class="nav-text">RTOM</span>
                    </a>

                </li>
                <li><a class="has-arrow ai-icon" href="<?= Yii::$app->urlManager->createUrl(['/cp/course'])?>">
